...
## Recherche complémentaire — 19 septembre 2026
Recherche Exa : Football-Data.co.uk et dépôt primaire Wyscout/Figshare. Le fichier Matches 7770422 v1 est publié sous CC BY 4.0 (métadonnées officielles https://api.figshare.com/v2/articles/7770422), auteurs Pappalardo et Massucco, DOI 10.6084/m9.figshare.7770422.v1. Archive matches.zip 645097 octets, MD5 51d80beb17480919f69a53a0152c2d71. Téléchargement tenté : HTTP 403 depuis cet environnement. Aucun import ni xG/forme actuelle ajouté. Saison 2017/18, coupe du monde 2018, Euro 2016.
Football-Data.co.uk : fichiers gratuits documentés, permission de republication non établie ; pas d’intégration. La page signale des cotes Pinnacle potentiellement périmées depuis juillet 2025. Aucun scraping de SofaScore/FotMob/FBref/WhoScored ni contournement.
Les nouveaux repères du championnat sont calculés exclusivement sur les scores déjà connectés, même saison, matchs terminés avant la date du match. Inconnus exclus, zéros conservés, sources affichées. Aucun changement du modèle.
